...
export type TimelineDawSessionKeyboardCommand = TimelineDawSessionNavigationAction | "pause-resume" | "launch-queued" | "cancel-queued" | "stop";
...
export function resolveTimelineDawSessionClipKeyboardCommand(
  ...
  if (!hasActiveClip || command === "stop" || command === "launch-queued" || command === "cancel-queued") return null;

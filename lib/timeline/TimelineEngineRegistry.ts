...
export const TIMELINE_ENGINE_CATALOG: TimelineEngineDescriptor[] = [
  ...
  descriptor("daw-session-coordinator", "TimelineDawSessionCoordinator", "production", ["session-recovery-performance", "multi-track-session"]),
  descriptor("daw-workspace-service", "TimelineDawWorkspaceService", "production", ["daw-session-coordinator"]),

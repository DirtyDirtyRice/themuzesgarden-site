...
const capabilities = [
  ...
  ["Inactive code holding", "Keeps incomplete code capsules outside active source until requirements, imports, declaration usage, TypeScript, and human activation pass."],

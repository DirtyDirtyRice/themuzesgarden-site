...
function SessionHealth({ session, snapshot, busy, onValidate, onInitialize, onActivate }: { session: DawSnapshot["sessions"][number]; snapshot: DawSnapshot; busy: boolean; onValidate: () => void; onInitialize: () => void; onActivate: () => void }) {

...
function SessionHealth({ session, snapshot, busy, onValidate, onInitialize }: { session: DawSnapshot["sessions"][number]; snapshot: DawSnapshot; busy: boolean; onValidate: () => void; onInitialize: () => void }) {

...
export type DawPrivateInsert = { id: string; sourceKind: "lane" | "bus"; sourceId: string; slot: number; effect: "gain" | "filter" | "compressor"; bypassed: boolean; parameters: Record<string, number>; latencySamples?: number };

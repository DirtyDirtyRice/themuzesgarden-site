...
import { addTimelineDawTrackRegionLabel, createTimelineDawTrackRegionSequence, parseTimelineDawTrackRegionLabels, removeTimelineDawTrackRegionLabel, timelineDawTrackLocalSeconds, updateTimelineDawTrackRegionLabel, type TimelineDawTrackRegionLabels } from "@/lib/timeline/TimelineDawTrackRegionLabelPolicy";
  ...
  function previewRiffFamily(regions: Array<{ laneId: string; startSeconds: number; endSeconds: number }>, repeatCount = 1) {
    ...
    const playNext = async (index: number) => {
      ...
      try {
        ...
        const advance = () => moveTo(createTimelineDawRiffAuditionNextIndex(index, plans.length));

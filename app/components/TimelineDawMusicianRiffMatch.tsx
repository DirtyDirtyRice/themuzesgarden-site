...
import TimelineDawRiffComparisonHelp from "@/app/components/TimelineDawRiffComparisonHelp";
import TimelineDawHybridEditHelp from "@/app/components/TimelineDawHybridEditHelp";

export default function TimelineDawMusicianRiffMatch({ sessionId, lanes, selectedIds, waveforms, onAudition, onAuditionFamily, auditionActive, auditionPaused, auditionProgress, onPauseAudition, onResumeAudition, onPreviousAudition, onReplayAudition, onSkipAudition, onStopAudition }: {
  sessionId: string;
  ...
  return <section className="mt-3 rounded-xl border border-cyan-300/25 bg-cyan-300/5 p-3">
    ...
    <TimelineDawRiffComparisonHelp sessionId={sessionId} />
    ...
    {matches?.length ? <TimelineDawHybridEditHelp sessionId={sessionId} /> : null}

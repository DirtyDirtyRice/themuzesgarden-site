...
export default function TimelineDawMusicianRiffMatch({ lanes, selectedIds, waveforms, onAudition, onAuditionFamily }: {
  ...
  onAuditionFamily?: (regions: Array<{ laneId: string; startSeconds: number; endSeconds: number }>) => void;
}) {

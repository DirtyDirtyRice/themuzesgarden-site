...
export default function TimelineDawMusicianRiffMatch({ lanes, selectedIds, waveforms, onAudition, onAuditionFamily, auditionActive, auditionProgress, onPreviousAudition, onSkipAudition, onStopAudition }: {

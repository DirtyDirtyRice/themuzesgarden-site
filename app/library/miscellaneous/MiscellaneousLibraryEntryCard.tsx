...
type MiscellaneousLibraryEntryCardProps = {
...
export default function MiscellaneousLibraryEntryCard({
  entry,
  onEditEntry,
  onDownloadEntry,
  onDuplicateEntry,
  onDeleteEntry,
}: MiscellaneousLibraryEntryCardProps) {
  return (
